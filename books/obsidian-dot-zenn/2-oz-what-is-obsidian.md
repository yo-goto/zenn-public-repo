...
現在ユーザーインターフェースの翻訳は最新版までキャッチアップしていますが、ドキュメントの翻訳についてはオリジナル版の大量変更に伴い一次停止している状況です (これは日本語だけではなく別の言語でも同様です)。とは言っても、あまりにも間が空きすぎてしまうと差分更新が非常に大変になってしまうためそろそろ更新し始めようと考えています。
