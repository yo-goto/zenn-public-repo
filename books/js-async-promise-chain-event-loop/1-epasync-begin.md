...
この本では、非同期処理の真髄と言っても過言ではない Promise チェーンとイベントループから非同期処理の重要であると筆者が個人的に感じたポイントを解説しています。学習経験から重要な情報に沿ってロードマップを再構成した作りとなっているので内容重視の解説順番となります。
...
この本で主に使う JavaScript の実行環境である Deno については uki00a さんの『Effective Deno』などが分かりやすいので参考にすると良いと思います。
...
- Microtask (またはマイクロタスク) 
  ...
  [^TaskとMacrotaskについて]: 最初は Task(タスク) よりも Macrotask(マクロタスク) の単語の方が理解しやすいかと思っていたのですが、Task(タスク) 方が本質を捉えやすい言葉だと感じたのでこちらをなるべく使っていきたいと思います。加えて Macro と Micro は似ているので見間違いやすいという理由もあります。
