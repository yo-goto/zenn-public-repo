...
先日、無料公開用のリポジトリとして今まで使用していた Zenn のリポジトリを Public にしました。以下のリポジトリでタイポなどのプルリクエストを受け付けています。

https://github.com/yo-goto/zenn-public-repo/tree/main/books/js-async-promise-chain-event-loop
