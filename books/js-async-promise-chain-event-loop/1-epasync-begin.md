...
具体的な流れとしては、非同期 API とそれを提供する環境についての話から始め、イベントループへの理解を深めます。具体的な非同期処理については、Promise の基礎的概念から Promise チェーンへと続き、最終的にはそこまでのすべての知識と V8 エンジンからのアプローチによって async/await の挙動を理解します。
...
内容としての充足度は 100% となっており、当初予定していた内容についてのチャプターはすべて収録済みとなります。ただし、第３章以降の内容についてはいくつか拡張していく可能性がありますので注意してください。他の章についてもより分かりやすい解説ができればチャプターを追加する可能性があります。
...
「そもそも Deno とか Node とかって何ですか？」という疑問がある場合には以下の記事などが分かりやすいとので参考にしてください。
