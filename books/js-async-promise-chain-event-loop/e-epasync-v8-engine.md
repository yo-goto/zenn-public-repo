...
V8 は DOM については一切感知しませんし、Web API も(ごく一部を覗いて)提供しません。後で解説しますが、**実は V8 エンジンはデフォルトのイベントループとタスクキュー/マイクロタスクキューを保有しています**。
...
:::message alert
この内容と次のコードについてはまだ理解できなくても大丈夫です。後のチャプターを読み進めていくうちに理解できるようになります。
:::
...
:::message alert
この内容についてはまだ理解できなくても大丈夫です。チャプター『それぞれのイベントループ』で詳しく解説しています。
:::
