...
TypeScript の基本については日本語でオープンソースに公開されている『[サバイバル TypeScript](https://typescriptbook.jp)』が非常に参考になります。筆者もお世話になっています。具体的な Promise の型注釈および async 関数における型注釈については以下のページで解説されています。
