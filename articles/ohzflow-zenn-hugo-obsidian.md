...
ZennやHugoについては知ってるけどObsidianについてはもっと基本的なことから知りたいという人がいると思うので、その場合には[jMatsuzaki](https://jmatsuzaki.com/archives/author/jmatsuzaki)さんの次の記事を参照してみてほしい。
...
![すべての記事とナレッジベースが並列](https://storage.googleapis.com/zenn-user-upload/yix5o25jppslah3pynq2nefebvme)
...
# OHZフロー
**ナレッジベースとしてのデジタルライブラリとメディアとしてのポストの融合させ、Obsidianの保管庫内部から様々ばレイヤーにアウトプットとしての記事をパブリッシュできるようにする**。
...
創発などの用語は**複雑系**や**システム論**の話につながるが、それはここでは置いておくとして、LYTの具体的な話は以下のNickのtwitter上のスレッドを追ってほしい。
